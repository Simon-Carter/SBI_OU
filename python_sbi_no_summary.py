...
posterior = infer(
    ou_process, prior, method="SNPE", num_simulations=75000, num_workers=12,
)
...
post_graph = analysis.pairplot(
    samples,
    points=torch.tensor([3,1,3]),
    limits=[[0, 5], [0, 5]], 
    points_colors="r",
    points_offdiag={"markersize": 6},
    figsize=(6, 6)
)
plt.savefig("plt_graph_111.png")




'''
observation = ou_process([3, 1, 3])

plt.plot(observation)
plt.savefig("ou_3_1_3.png")
