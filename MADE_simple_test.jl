...
model = MADE(MaskedLinear(2, 3, relu), MaskedLinear(3, 4, relu), MaskedLinear(4, 6, relu), MaskedLinear(6, 5, relu), MaskedLinear(5,4))

tstate = Lux.Training.TrainState(rng, model, opt);


train_dataloader = generate_data_maf_paper(20000,5000)
...
tstate = main(tstate, vjp_rule, train_dataloader, 250)